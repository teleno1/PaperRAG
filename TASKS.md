...
| Task | Status | Details |
|------|--------|---------|
| T0-01 | todo | [Phase 0](docs/tasks/phase-0.md#t0-01-update-gitignore-for-generated-artifacts) |
| T0-02 | todo | [Phase 0](docs/tasks/phase-0.md#t0-02-audit-and-slim-data) |
...
| T2-02 | todo | [Phase 2](docs/tasks/phase-2.md#t2-02-implement-txt-and-markdown-parsers) |
| T2-03 | todo | [Phase 2](docs/tasks/phase-2.md#t2-03-wrap-mineru-as-the-pdf-parser) |
| T2-04 | todo | [Phase 2](docs/tasks/phase-2.md#t2-04-index-a-tiny-txtmarkdown-sample-corpus) |
| T3-01 | todo | [Phase 3](docs/tasks/phase-3.md#t3-01-add-cited-answer-use-case) |
