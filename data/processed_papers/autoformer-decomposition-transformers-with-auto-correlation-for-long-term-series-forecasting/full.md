...
Haixu Wu, Jiehui Xu, Jianmin Wang, Mingsheng Long (B)
...
$$
\mathcal {X} _ {\text {e n s}}, \mathcal {X} _ {\text {e n t}} = \operatorname {S e r i e s D e c o m p} \left(\mathcal {X} _ {\text {e n} \frac {I}{2}: I}\right)
$$
...
![](images/ac4d76fb6d8e032dabe438a98896c42050c5f02bdaac8c3a33cacf0b3a2e31ee.jpg)  
...
$$
\mathcal {S} _ {\mathrm {e n}, -} ^ {l, 1} = \operatorname {S e r i e s D e c o m p} \left(\text {A u t o - C o r r e l a t i o n} \left(\mathcal {X} _ {\mathrm {e n}} ^ {l - 1}\right) + \mathcal {X} _ {\mathrm {e n}} ^ {l - 1}\right) \tag {3}
$$
...
$\mathcal { X } _ { \mathrm { d e } } ^ { l } = { S } _ { \mathrm { d e } } ^ { l , 3 } , l \in \{ 1 , \cdots , M \}$ tes the output of is for accumula $l$ $\mathcal { X } _ { \mathrm { d e } } ^ { 0 }$ is embedded from2, 3} represent the $\mathcal { X } _ { \mathrm { d e s } }$ $\mathcal { T } _ { \mathrm { d e } } ^ { 0 } = \mathcal { X } _ { \mathrm { d e t } }$ $S _ { \mathrm { d e } } ^ { l , i }$ $\mathcal { T } _ { \mathrm { d e } } ^ { l , i }$ $i$ $l$ -th layer respectively. $\mathcal { W } _ { l , i } , i \in \{ 1 , 2 , 3 \}$ represents the projector for the $i$ -th extracted trend $\mathcal { T } _ { \mathrm { d e } } ^ { l , i }$ .

![](images/df8313c958d2dec2e615c0061db35963d9fd43401dc76e3f506a99bf04aafb9f.jpg)

![](images/7cb4c07041f5ced74ba84797c2e6c8d3bba6f059fb4d3a62171ca76368d27489.jpg)  
...
The final prediction is the sum of the two refined decomposed components, as $\mathcal { W } _ { S } \ast \mathcal { X } _ { \mathrm { d e } } ^ { M } + \mathcal { T } _ { \mathrm { d e } } ^ { M }$ where $\mathcal { W } _ { \mathcal { S } }$ is to project the deep transformed seasonal component $\chi _ { \mathrm { d e } } ^ { M }$ to the target dimension.
...
$$
\operatorname {A u t o - C o r r e l a t i o n} (\mathcal {Q}, \mathcal {K}, \mathcal {V}) = \sum_ {i = 1} ^ {k} \operatorname {R o l l} (\mathcal {V}, \tau_ {i}) \widehat {\mathcal {R}} _ {\mathcal {Q}, \mathcal {K}} (\tau_ {i}),
$$

where arg Topk(·) is to get the arguments of the Topk autocorrelations and let $k = \lfloor c \times \log L \rfloor$ , $c$ is a hyper-parameter. $\mathcal { R } _ { \mathcal { Q } , \kappa }$ is autocorrelation between series $\mathcal { Q }$ and $\kappa$ . $\mathrm { R o l l } ( \mathcal { X } , \tau )$ represents the operation to $\mathcal { X }$ with time delay $\tau$ , during which elements that are shifted beyond the first position are re-introduced at the last position. For the encoder-decoder Auto-Correlation (Figure 1), $\kappa , \nu$ are from the encoder $\chi _ { \mathrm { e n } } ^ { N }$ and will be resized to length- $O$ , $\mathcal { Q }$ is from the previous block of the decoder.

![](images/1679a842acdeedbdc759f903803a16442e15bf76eafcf7d0958b89844b2e143e.jpg)

![](images/60a0c1e266ed50c7b96af881f65f1c9303059e872c2746c6778546b5c7c9c9d1.jpg)

![](images/72b8060dc1acd42bf6fac4be747a6a9bd823f1924859e34582cc38ceb8cede30.jpg)

![](images/c99b4989e6a0b0215f71c12657746edbc1cba0f9335e90c79adc656708d01829.jpg)  
...
![](images/973f3fc2b6161793cc8eca2098bbd9f0edf30e4a36d62fa9404a5b189bfbc810.jpg)  
(a) Without decomposition block

![](images/187abf214565d57ba748b59b1eba87e13c51a2f2795ae3ec996efe5e4e6941b1.jpg)  
(b) One decomposition block

![](images/7d60ab591e820fab2ba580359530cbb01661a36996758341ce26fcb321504b2f.jpg)  
(c) Two decomposition blocks

![](images/25734e94a882cf3afd2a2de099d3910de94aa646a44f73d6c3aa6dbadeaf9511.jpg)  
...
Dependencies learning The marked time delay sizes in Figure 5(a) indicate the most likely periods. Our learned periodicity can guide the model to aggregate the sub-series from the same or neighbor phase of periods by $\mathrm { R o l l } ( \mathcal { X } , \tau _ { i } )$ , $i \in \{ 1 , \cdots , 6 \}$ . For the last time step (declining stage), Auto-Correlation fully utilizes all similar sub-series without omissions or errors compared to self-attentions. This verifies that Autoformer can discover the relevant information more sufficiently and precisely.
...
![](images/8075cb3b6560e96244b864f13cade2dc8f5c93888afd73c4dabc59065cd7a232.jpg)  
(a) Auto-Correlation

![](images/fbabc2526b4affd226fa91319739dcdbfdd01f284f43d8a5186102e23c251c2c.jpg)  
(b) Full Attention

![](images/19c2f0e9f5297ce1bdbed8f2c23b572dd566acde120f0f1456746cb337a523a7.jpg)  
(c) LSH Attention

![](images/8d18da9087490e894ad2feb91ea0487a72f65c46a090126d93b40585490ee615.jpg)  
(d) ProbSparse Attention

![](images/fc227f57cae734df9d4dd5d005741aa628b2b4691573036d9933eca5f4311d73.jpg)  
...
![](images/4eb3b5186bdce9102a3b6ea255df3521ae869fd169d2befd1fca84380b9d8428.jpg)  
(b) Exchange (Daily Recorded)

![](images/bd4a7e7be996639c338ea9e4d6789787d4907beb61b0377b2fdf696f6917649e.jpg)  
(c) Traffic (Hourly Recorded)

![](images/987c70277f4507ce5dfc4bea4c8a7f3806fb0343f1313b0feb0e4a9a4cb76103.jpg)  
...
![](images/97979cf23a4c3a68da5e53991c04203c85994ee0d41d4903865cd636dd7031bb.jpg)  
(a) Memory Efficiency Analysis

![](images/b8add171563f19a9f7c0b224e2a16a787f22e59774647728e6bf15d3ddf1b69c.jpg)  
