...
function OperationCard({ operation, papers, onRetry, onRetryOutline, onRetryReport, busyKey }: { operation: WorkspaceOperation; papers: ResearchPaper[]; onRetry: (paper: ResearchPaper) => void; onRetryOutline: (operation: WorkspaceOperation) => void; onRetryReport: (operation: WorkspaceOperation) => void; busyKey: string | null }) {
